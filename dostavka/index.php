		...
		<div class="single-header__content">
			<div class="wrapper wrapper_default">
				...
				<div class="single__desc">
					<p>
                        <?=
                            DOMAIN_ZONE == 'kz' ? 'Кургандормаш предоставляет услуги по перевозке и перегону техники по территории Казахстана.&nbsp;' : 'Кургандормаш предоставляет услуги по перевозке и перегону техники по территории России.&nbsp;';
                        ?>
				...
				<div class="row">
					<div class="col col--lg-10 col--lg-offset-1">
						<div class="paragraph">
							<p>
 <br>
								Мы сотрудничаем только с проверенными транспортными компаниями, прошедшими проверку на благонадежность и обладающими многолетним опытом по перевозке стандартных и негабаритных грузов любыми видами транспорта. Сотрудники Кургандормаш — профессионалы в решении сложных транспортных задач, имеют практические знания по доставке грузов разными видами транспорта по всей стране. Стоимость и условия доставки уточняйте у менеджеров по продажам грузовой техники. <br>
								<br>
							</p>
 ...
 <i class="warning__ico iconed__ico">!</i>
								<div class="warning__content">
									<p class="title title_large">
										 Внимание! Доставка техники является дополнительной услугой для покупателей техники Кургандормаш и не является основным видом деятельности компании.
									</p>
								</div>
							</div>
						</div>

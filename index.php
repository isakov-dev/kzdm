		...
		<div class="row">
			<div class="col col--lg-10 col--lg-offset-1">
				<div class="about-widget">
					<h4 class="h4 about-widget__title title title_small-offset">Производим специальную технику с 1941 года</h4>
					<div class="toggler about-widget__content">
						<div class="paragraph paragraph_middle homepage-text">
                            <p>«Кургандормаш» уже более 75 лет выпускает качественную технику, прошедшую все испытания и
                                отвечающую современным потребительским запросам и требованиям безопасности, благодаря
                                ...
                                сеть, гарантирующую подлинность товара, обеспечивающую полную предпродажную подготовку и
                                послепродажное обслуживание. </p>
                            <p>В коллективе работают высококвалифицированные конструктора и технологи, опытные токари,
                                сварщики, фрезеровщики. Высокое качество выпускаемых машин и безупречный сервис служат

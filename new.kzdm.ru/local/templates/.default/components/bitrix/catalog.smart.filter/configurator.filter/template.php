...
?>
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="filter__form">
			...
			<?
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					?>
						...
						<p class="filter__header"><?=$arItem['NAME']?></p>
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								default:
									?>
										...
										<?foreach($arItem["VALUES"] as $val => $ar):?>
											<label class="filter__name <? echo $ar["DISABLED"] ? 'filter-disabled': '' ?>">
												<input type="checkbox" 
												...
												<? echo $ar["CHECKED"]? 'checked="checked"': '' ?>
													...
													onclick="smartFilter.click(this)"
												>	<?=$ar["VALUE"];?>
												<span class="filter__custombox"></span>
											</label>

...
<div class="single single_offset">
    <div class="card">
        ...
        if (!empty($ipropValues->getValues()['ELEMENT_META_DESCRIPTION'])) {
            ...
            $APPLICATION->SetPageProperty('description', trim(preg_replace('/\s\s+/', ' ', $string)) . '.');
        }
        ?>
                                ...
                                <div class="row row_center">
                                    <div class="col col--lg-3">
                                        <div class="full-preim__item">
                                            <img class="full-preim__ico" src="<?= SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/datepicker-circle.svg" alt="">
                                            <span class="full-preim__title title_demi title_block title_centered">
                                                <?= Bitrix\Main\Localization\Loc::getMessage('DELIVERY_TIME'); ?>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col col--lg-3">
                                        <div class="full-preim__item">
                                            <img class="full-preim__ico" src="<?= SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/award-circle.svg" alt="">
                                            <span class="full-preim__title title_demi title_block title_centered">
                                                <?= Bitrix\Main\Localization\Loc::getMessage('GUARANTEE'); ?>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col col--lg-3">
                                        <div class="full-preim__item">
                                            <img class="full-preim__ico" src="<?= SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/build-circle.svg" alt="">
                                            <span class="full-preim__title title_demi title_block title_centered">
                                                <?= Bitrix\Main\Localization\Loc::getMessage('SELLING'); ?>
                                            </span>
                                        </div>
                                    </div>

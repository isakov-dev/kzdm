    ...
    <div class="city">
      <a href="#" data-src="#city-popup" class="inline-popup-trigger city-btn iconed iconed_center">
        ...
        <span class="city-btn__content">
                    <span
                        class="city-btn__title "><?= SITE_ID == 'en' ? $arResult['TITLE_EN'] : $arResult['TITLE']; ?></span>
      ...
      <?php if (empty($context->getRequest()->getCookie('CITY_ID'))): ?>
        <div class="header-active-city__selector">
          <div
              class="header-active-city__selector-title"><?= Bitrix\Main\Localization\Loc::getMessage('CITY_SELECTOR_TITLE'); ?></div>
          <div class="header-active-city__selector-buttons">
            <a id="confirm-city" class="header-active-city__selector-btn success" href="<?= $arResult['DOMAIN']; ?>"
               data-id="<?= $arResult['ID']; ?>"><?= Bitrix\Main\Localization\Loc::getMessage('CITY_SELECTOR_BUTTON_SUCCESS'); ?></a>
            <button class="header-active-city__selector-btn wrong inline-popup-trigger city-btn" type="button"
                    data-src="#city-popup"><?= Bitrix\Main\Localization\Loc::getMessage('CITY_SELECTOR_BUTTON_WRONG'); ?></button>
          </div>
        </div>
      <?php endif; ?>
  </div>

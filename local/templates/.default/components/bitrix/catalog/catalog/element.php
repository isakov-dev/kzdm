...
<div class="single single_offset">
    <div class="card">
        ...
        //ебучий ты блять нахуй битрикс. почему я должен такие вещи делать во вьюхе. Почему, мрази, ваш же родной функционал, по вашим блять вшивым канонам НЕ РАБОТАЕТ? А? Мрази! Чтоб вас выебали в жопу черти!
        $ipropValues = new \Bitrix\Iblock\InheritedProperty\ElementValues(
            $arParams['IBLOCK_ID'],
            $elementId
        );

        $APPLICATION->SetPageProperty('title', str_replace('{current_city}', getCurrentCity(), $ipropValues->getValues()['ELEMENT_META_TITLE']));
        if (!empty($ipropValues->getValues()['ELEMENT_META_DESCRIPTION'])) {
            $string = strip_tags(html_entity_decode($ipropValues->getValues()['ELEMENT_META_DESCRIPTION']));
        ...
        <div class="section section_animated wow">
            <div class="full-preim" style="background-image: url('<?= SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/cars-preims.jpg')">
                <div class="full-preim__content">
                    <div class="wrapper wrapper_default">
                        <div class="row row_center">
                            <div class="col col--xl-8">
                                <div class="row">
                                    <div class="col col--md-3">
                                        <div class="full-preim__item">
                                            <img class="full-preim__ico" src="<?= SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/datepicker-circle.svg" alt="<?= Bitrix\Main\Localization\Loc::getMessage('DELIVERY_TIME'); ?>">
                                            <span class="full-preim__title title_demi title_block title_centered"><?= Bitrix\Main\Localization\Loc::getMessage('DELIVERY_TIME'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col col--md-3">
                                        <div class="full-preim__item">
                                            <img class="full-preim__ico" src="<?= SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/award-circle.svg" alt="<?= Bitrix\Main\Localization\Loc::getMessage('GUARANTEE'); ?>">
                                            <span class="full-preim__title title_demi title_block title_centered"><?= Bitrix\Main\Localization\Loc::getMessage('GUARANTEE'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col col--md-3">
                                        <div class="full-preim__item">
                                            <img class="full-preim__ico" src="<?= SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/build-circle.svg" alt="<?= Bitrix\Main\Localization\Loc::getMessage('SELLING'); ?>">
                                            <span class="full-preim__title title_demi title_block title_centered"><?= Bitrix\Main\Localization\Loc::getMessage('SELLING'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col col--md-3">
                                        <div class="full-preim__item">
                                            <img class="full-preim__ico" src="<?= SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/user-circle.svg" alt="<?= Bitrix\Main\Localization\Loc::getMessage('TRAINING'); ?>">
                                            <span class="full-preim__title title_demi title_block title_centered"><?= Bitrix\Main\Localization\Loc::getMessage('TRAINING'); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>

...
?><div class="single">
		...
		<div class="single-header__content">
			<div class="wrapper wrapper_default">
				...
				<div class="single__desc">
					<p>
						 Официальные предствительства АО "Кургандормаш" есть во всех федеральных округах России. Для удобства вы можете связаться со специалистом в вашем регионе.
					</p>
				</div>
			</div>
		</div>
	...
	Array(
		...
		"STRICT_SECTION_CHECK" => "N"
				...
				<div class="section section_default section_animated wow">
					<div class="buy-preim">
						<h2 class="h2 buy-preim__title sales-widget__title">Покупая технику у представительства вы гарантированно получите</h2>
					...
					<div class="sales-baners">
						<div class="row">
							<div class="col col--lg-4 col--sm-6">
								<div class="tile-imagered tile-imagered_large match-height" style="background-color: #0f3599;">
 <a href="/servis/obuchenie-i-obsluzhivanie/" class="tile-imagered__content tile-imagered__content_l"> <span class="tile-imagered__title tile-imagered__title title title_b-offset">
 ...
 <img src="<?= SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/half-logo.svg" class="tile-imagered__pic tile-imagered__pic__centered" alt=""> </a>
								</div>
							</div>
							<div class="col col--lg-4 col--sm-6">
 <a href="/servis/vyezdnoy-servis/" class="tile-imagered tile-imagered_large match-height" style="background-color: #0f3599;">
 ...
 <img src="<?= SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/baner-crop.png" class="tile-imagered__pic tile-imagered__pic_l" alt="">
								</div>
 </a>
							</div>
							<div class="col col--lg-4 col--sm-12">
								<div class="tile-imagered tile-imagered_large match-height" style="background-color: #0f3599;">
 <a href="/dostavka/" class="tile-imagered__content tile-imagered__content_l"> <span class="tile-imagered__title title title_b-offset">
									Подробнее<br>
									 о доставке<br>
									 техники </span> <img src="<?=SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/md.png" class="tile-imagered__pic tile-imagered__pic_r-b" alt=""> </a>
								</div>
							</div>
						</div>
					</div>

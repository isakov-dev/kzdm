...
$APPLICATION->SetTitle("Jobs");
$APPLICATION->SetPageProperty('title', 'Jobs');
?><div class="single">
		...
		<div class="single-header__content">
			<div class="wrapper wrapper_default">
				...
				<div class="single__desc">
					<p>
						 If you want to become part of a strong enterprise, we suggest that you consider the vacancies proposed by us
					</p>
				</div>
			</div>
		</div>
 ...
 <a href="https://kurgan.zarplata.ru/companies/20569641" class="tile-imagered tile-imagered_dark match-height" style="background-color: #EEF1F4" target="_blank"> <span class="tile-imagered__content"> <span class="tile-imagered__title">All current vacancies look at zarplata.ru</span> <span class="tile-imagered__site"> <img src="<?= SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/zarplata.png" alt=""> </span> <span class="btn btn_submit btn_box btn_orange">Go to the website</span> </span> <img src="<?= SITE_DEFAULT_TEMPLATE_PATH; ?>/assets/images/man-worker.png" class="tile-imagered__pic tile-imagered__pic_man tile-imagered__pic_offset" alt=""> </a>
									</div>
									<div class="col col--lg-6">
 ...
 <span class="tile-imagered__title">If you do not have an account</span>
												<p>
													 If you do not have an account for zarplata.ru, you can call <a href="tel:+73522443620">+7 (352) 244-36-20</a> or write to the email <a href="mailto:ivanova_ia@kzdm.ru">ivanova_ia@kzdm.ru</a>
												</p>
